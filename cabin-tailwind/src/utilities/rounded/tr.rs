...
/// ```
pub const NONE: Property<Length, 2> = Property(BORDER_TOP_RIGHT_RADIUS, Length::Px(0.0));

/// ```css
/// border-top-right-radius: 0.25rem;
/// ```
pub const DEFAULT: Property<Length, 2> = Property(BORDER_TOP_RIGHT_RADIUS, Length::Rem(0.25));

/// ```css
/// border-top-right-radius: 9999px;
/// ```
pub const FULL: Property<Length, 2> = Property(BORDER_TOP_RIGHT_RADIUS, Length::Px(9999.0));
