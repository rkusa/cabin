...
/// line-height: 1;
/// ```
pub const NONE: Property<f64> = Property(LINE_HEIGHT, 1.0);

/// ```css
/// line-height: 1.25;
/// ```
pub const TIGHT: Property<f64> = Property(LINE_HEIGHT, 1.25);

/// ```css
/// line-height: 1.375;
/// ```
pub const SNUG: Property<f64> = Property(LINE_HEIGHT, 1.375);

/// ```css
/// line-height: 1.5;
/// ```
pub const NORMAL: Property<f64> = Property(LINE_HEIGHT, 1.5);

/// ```css
/// line-height: 1.625;
/// ```
pub const RELAXED: Property<f64> = Property(LINE_HEIGHT, 1.625);

/// ```css
/// line-height: 2;
/// ```
pub const LOOSE: Property<f64> = Property(LINE_HEIGHT, 2.0);
