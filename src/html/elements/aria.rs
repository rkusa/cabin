...
pub struct Aria {
    ...
    pub aria_active_descendant: Option<Cow<'static, str>>,
    ...
    pub aria_autocomplete: Option<AutoAutocomplete>,
    ...
    pub aria_colindextext: Option<Cow<'static, str>>,
    ...
    pub aria_error_message: Option<Cow<'static, str>>,
    ...
    pub aria_flow_to: Option<Cow<'static, str>>,
    ...
    pub aria_multi_line: Option<bool>,
    ...
    pub aria_multi_selectable: Option<bool>,
    ...
    pub aria_placeholder: Option<Cow<'static, str>>,
    ...
    pub aria_row_index_text: Option<Cow<'static, str>>,
